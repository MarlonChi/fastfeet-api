...
import { ListDeliveryManController } from './list-deliveryman.controller';
...
describe('ListDeliveryMenController', () => {
  let controller: ListDeliveryManController;
  let prismaService: PrismaService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      controllers: [ListDeliveryManController],
      providers: [
        {
    ...
    controller = module.get<ListDeliveryManController>(
      ListDeliveryManController,
    );
